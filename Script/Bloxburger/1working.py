...
def main():
    ...
    costumer_click_image_1(Lettuce_1, Lettuce)
    costumer_click_image_2(Lettuce_2, Lettuce)
    costumer_click_image_1(Tomato_1, Tomato)
    costumer_click_image_2(Tomato_2, Tomato)
    costumer_click_image_1(Normal_beef_1, Normal_beef)
    costumer_click_image_2(Normal_beef_2, Normal_beef)
    costumer_click_image_1(Vegan_beef_1, Vegan_beef)
    costumer_click_image_2(Vegan_beef_2, Vegan_beef)
    costumer_click_image_1(Cheese_1, Cheese)
    costumer_click_image_2(Cheese_2, Cheese)
    costumer_click_image_1(Onion_1, Onion)
    costumer_click_image_2(Onion_2, Onion)
